...
pub fn prometheus_metrics() -> warp::filters::log::Log<impl Fn(warp::filters::log::Info) + Clone> {
    warp::log::custom(move |info| {
        ...
        let path = {
            ...
            equals("v1/beacon/blocks/head/root")
                .or_else(|| starts_with("v1/beacon/blocks"))
                ...
                .or_else(|| starts_with("v1/beacon/light_client/bootstrap"))
                .or_else(|| starts_with("v1/beacon/light_client/updates"))
                .or_else(|| starts_with("v1/beacon/light_client/finality_update"))
                .or_else(|| starts_with("v1/beacon/light_client/optimistic_update"))
                ...
                .or_else(|| starts_with("v2/validator/blocks/blinded"))
